...
export class Font {
    ...
    static getGlyph(font: Pango.Font, wc: number): number
    static getUnknownGlyph(font: Pango.Font, wc: number): Pango.Glyph
    static hasChar(font: Pango.Font, wc: number): boolean
    static unlockFace(font: Pango.Font): void
