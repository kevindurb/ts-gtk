...
export function objectInfoFindMethod(info: ObjectInfo, name: string): FunctionInfo
export function objectInfoFindMethodUsingInterfaces(info: ObjectInfo, name: string): [ /* returnType */ FunctionInfo, /* implementor */ ObjectInfo ]
export function objectInfoFindSignal(info: ObjectInfo, name: string): SignalInfo
export function objectInfoFindVfunc(info: ObjectInfo, name: string): VFuncInfo
export function objectInfoFindVfuncUsingInterfaces(info: ObjectInfo, name: string): [ /* returnType */ VFuncInfo, /* implementor */ ObjectInfo ]
export function objectInfoGetAbstract(info: ObjectInfo): boolean
export function objectInfoGetClassStruct(info: ObjectInfo): StructInfo
...
export function objectInfoGetGetValueFunction(info: ObjectInfo): string
...
export function objectInfoGetParent(info: ObjectInfo): ObjectInfo
export function objectInfoGetProperty(info: ObjectInfo, n: number): PropertyInfo
export function objectInfoGetRefFunction(info: ObjectInfo): string
export function objectInfoGetSetValueFunction(info: ObjectInfo): string
...
export function objectInfoGetUnrefFunction(info: ObjectInfo): string
