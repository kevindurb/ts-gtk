...
export interface DBusSignalCallback {
    (connection: DBusConnection, senderName: string, objectPath: string, interfaceName: string, signalName: string, parameters: GLib.Variant): void
}
...
export class DesktopAppInfoLookup {
    ...
    vfuncGetDefaultForUriScheme?(uriScheme: string): AppInfo
    static name: string
}
export class Drive {
...
export class ThreadedSocketService {
    ...
    connect(sigName: "run", callback: (($obj: ThreadedSocketService, connection: SocketConnection, sourceObject: GObject.Object) => boolean)): number
    connect_after(sigName: "run", callback: (($obj: ThreadedSocketService, connection: SocketConnection, sourceObject: GObject.Object) => boolean)): number
    emit(sigName: "run", connection: SocketConnection, sourceObject: GObject.Object): void
